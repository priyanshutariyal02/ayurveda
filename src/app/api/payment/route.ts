...
const sendConfirmationEmails = async (
  ...
  await transporter.sendMail({
    ...
    html: `
      ...
      <p>Google Meet Link: <a href="${`https://meet.google.com/kmo-pbra-fae`}">Join meet according to your timeslot</a></p>
  ...
  await transporter.sendMail({
    ...
    html: `
      ...
      <ul>
        <li>Name: ${appointmentDetails.name}</li>
      ...
      <p>Google Meet Link: <a href="${"https://meet.google.com/kmo-pbra-fae"}">Join Meet</a></p>
