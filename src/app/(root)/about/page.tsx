  ...
  return (
    <div className="w-full px-5 lg:px-16 py-16 text-gray-900">
      <div className="w-full flex flex-col justify-center items-center gap-12">
        <h1 className="text-h2-display text-center text-gray-700">About Us</h1>
        ...
        <div className="lg:hidden flex flex-col items-center justify-center w-full px-6 py-12 space-y-8">
          <div className="w-full p-6 border-l-4 border-primary bg-primary/5 rounded-lg">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              To be a global leader in holistic health and wellness by offering
              authentic Ayurvedic treatments and therapies that restore balance
              and promote overall well-being. We envision a world where
              traditional Ayurvedic knowledge and modern medical practices unite
          ...
          <div className="w-full p-6 border-l-4 border-secondary-green bg-secondary-green/5 rounded-lg">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              Our mission at{" "}
              <span className="font-semibold">Tulsi Ayurveda Clinic</span> is to
              provide personalized and comprehensive Ayurvedic healthcare
              ...
              ensuring Ayurveda is not just seen as an alternative treatment but
      ...
      <div className="w-full mt-12">
        <div className="w-full flex flex-col items-center mb-10">
          ...
          <p className="text-lg text-gray-700 max-w-2xl mt-4 md:text-center">
            Tulsi Ayurveda blends ancient wisdom with modern wellness to restore
            balance in mind, body, and spirit. With personalized treatments and
            expert guidance, we help you embrace Ayurveda as a path to natural
